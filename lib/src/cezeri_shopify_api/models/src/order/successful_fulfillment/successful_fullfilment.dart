...
abstract class SuccessfulFullfilment with _$SuccessfulFullfilment {
  ...
  factory SuccessfulFullfilment({required String? trackingCompany, required List<SuccessfulFullfilmentTrackingInfo>? trackingInfo}) =
  ...
  factory SuccessfulFullfilment.fromGraphJson(Map<String, dynamic> json) =>
      SuccessfulFullfilment(trackingCompany: json['trackingCompany'], trackingInfo: _getTrackingInfoList(json['trackingInfo'] ?? []));
  ...
  static List<SuccessfulFullfilmentTrackingInfo> _getTrackingInfoList(List<dynamic> data) {
