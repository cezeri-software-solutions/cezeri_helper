...
abstract class Order with _$Order {
  ...
  factory Order.fromGraphJson(Map<String, dynamic> json) => Order(
    ...
    shippingAddress: json['node']['shippingAddress'] == null ? null : ShippingAddress.fromJson(json['node']['shippingAddress']),
    billingAddress: json['node']['billingAddress'] == null ? null : ShippingAddress.fromJson(json['node']['billingAddress']),
    ...
    successfulFulfillments: _getSuccessfulFulfilments(json['node']['successfulFulfillments'] ?? []),
  );

  /// The order from json
  factory Order.fromJson(Map<String, dynamic> json) => _$OrderFromJson(json);

  static List<SuccessfulFullfilment> _getSuccessfulFulfilments(List<dynamic> fulfilments) {
