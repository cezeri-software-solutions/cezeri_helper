...
mixin _$Checkout {
 ...
 String get id; bool get ready; AvailableShippingRates? get availableShippingRates; String get createdAt; String get currencyCode; PriceV2 get totalTaxV2; PriceV2 get totalPriceV2; bool get taxesIncluded; bool get taxExempt; PriceV2 get subtotalPriceV2; bool get requiresShipping; List<AppliedGiftCards> get appliedGiftCards; List<LineItem> get lineItems; Order? get order; String? get orderStatusUrl; String? get shopifyPaymentsAccountId; MailingAddress? get shippingAddress; ShippingRates? get shippingLine; String? get email; String? get completedAt; String? get note; String? get webUrl; String? get updatedAt;
...
@useResult
$Res call({
 String id, bool ready, AvailableShippingRates? availableShippingRates, String createdAt, String currencyCode, PriceV2 totalTaxV2, PriceV2 totalPriceV2, bool taxesIncluded, bool taxExempt, PriceV2 subtotalPriceV2, bool requiresShipping, List<AppliedGiftCards> appliedGiftCards, List<LineItem> lineItems, Order? order, String? orderStatusUrl, String? shopifyPaymentsAccountId, MailingAddress? shippingAddress, ShippingRates? shippingLine, String? email, String? completedAt, String? note, String? webUrl, String? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  bool ready,  AvailableShippingRates? availableShippingRates,  String createdAt,  String currencyCode,  PriceV2 totalTaxV2,  PriceV2 totalPriceV2,  bool taxesIncluded,  bool taxExempt,  PriceV2 subtotalPriceV2,  bool requiresShipping,  List<AppliedGiftCards> appliedGiftCards,  List<LineItem> lineItems,  Order? order,  String? orderStatusUrl,  String? shopifyPaymentsAccountId,  MailingAddress? shippingAddress,  ShippingRates? shippingLine,  String? email,  String? completedAt,  String? note,  String? webUrl,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Checkout() when $default != null:
...
class _Checkout extends Checkout {
   _Checkout({required this.id, required this.ready, required this.availableShippingRates, required this.createdAt, required this.currencyCode, required this.totalTaxV2, required this.totalPriceV2, required this.taxesIncluded, required this.taxExempt, required this.subtotalPriceV2, required this.requiresShipping, final  List<AppliedGiftCards> appliedGiftCards = const [], required final  List<LineItem> lineItems, this.order, this.orderStatusUrl, this.shopifyPaymentsAccountId, this.shippingAddress, this.shippingLine, this.email, this.completedAt, this.note, this.webUrl, this.updatedAt}): _appliedGiftCards = appliedGiftCards,_lineItems = lineItems,super._();
