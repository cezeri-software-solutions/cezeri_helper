...
_TokanizedCheckout _$TokanizedCheckoutFromJson(Map<String, dynamic> json) => _TokanizedCheckout(
...
Map<String, dynamic> _$TokanizedCheckoutToJson(_TokanizedCheckout instance) => <String, dynamic>{
