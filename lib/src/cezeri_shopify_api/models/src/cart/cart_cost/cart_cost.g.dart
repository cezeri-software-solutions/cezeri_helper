...
_CartCost _$CartCostFromJson(Map<String, dynamic> json) => _CartCost(
  checkoutChargeAmount: PriceV2.fromJson(json['checkoutChargeAmount'] as Map<String, dynamic>),
  ...
  totalDutyAmount: json['totalDutyAmount'] == null ? null : PriceV2.fromJson(json['totalDutyAmount'] as Map<String, dynamic>),
  totalDutyAmountEstimated: json['totalDutyAmountEstimated'] as bool,
  totalTaxAmount: json['totalTaxAmount'] == null ? null : PriceV2.fromJson(json['totalTaxAmount'] as Map<String, dynamic>),
