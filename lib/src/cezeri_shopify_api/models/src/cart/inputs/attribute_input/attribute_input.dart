...
abstract class AttributeInput with _$AttributeInput {
  ...
  factory AttributeInput({required String key, required String value}) = _AttributeInput;

  /// The attribute input from json factory
  factory AttributeInput.fromJson(Map<String, dynamic> json) => _$AttributeInputFromJson(json);
}
