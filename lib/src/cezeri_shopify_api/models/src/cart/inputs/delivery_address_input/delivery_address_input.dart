...
abstract class DeliveryAddressInput with _$DeliveryAddressInput {
  ...
  @Assert('customerAddressId == null || deliveryAddress == null', 'Cannot contain both customerAddressId and deliveryAddress')
  /// The delivery address input constructor
  factory DeliveryAddressInput({String? customerAddressId, MailingAddressInput? deliveryAddress}) = _DeliveryAddressInput;
