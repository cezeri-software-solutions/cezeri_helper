...
abstract class Blog with _$Blog {
  ...
  factory Blog({String? id, String? handle, String? title, String? onlineStoreUrl, Articles? articles}) = _Blog;
  ...
  factory Blog.fromGraphJson(Map<String, dynamic> json) => Blog(
    ...
    articles: Articles.fromGraphJson(((json['node'] ?? const {})['articles']) ?? const {}),
  );
