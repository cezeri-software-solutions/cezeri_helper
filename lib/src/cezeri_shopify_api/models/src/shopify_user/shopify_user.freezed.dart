...
class _ShopifyUser implements ShopifyUser {
   _ShopifyUser({this.address, this.createdAt, this.displayName, this.email, this.firstName, this.id, this.lastName, this.phone, final  List<String>? tags, this.defaultAddress}): _tags = tags;
