...
class AccessTokenWithExpDate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accessToken': accessToken, 'expiresAt': expiresAt?.millisecondsSinceEpoch};
  }
  ...
  factory AccessTokenWithExpDate.fromJson(String source) => AccessTokenWithExpDate.fromMap(json.decode(source) as Map<String, dynamic>);
