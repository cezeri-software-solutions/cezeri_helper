...
_AddressPrediction _$AddressPredictionFromJson(Map<String, dynamic> json) => _AddressPrediction(
...
Map<String, dynamic> _$AddressPredictionToJson(_AddressPrediction instance) => <String, dynamic>{
