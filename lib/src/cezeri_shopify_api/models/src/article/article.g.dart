...
_Article _$ArticleFromJson(Map<String, dynamic> json) => _Article(
  author: json['author'] == null ? null : AuthorV2.fromJson(json['author'] as Map<String, dynamic>),
  commentList: (json['commentList'] as List<dynamic>?)?.map((e) => Comment.fromJson(e as Map<String, dynamic>)).toList(),
