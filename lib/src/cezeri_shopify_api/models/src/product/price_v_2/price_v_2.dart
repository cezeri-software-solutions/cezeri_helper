...
abstract class PriceV2 with _$PriceV2 {
  ...
  factory PriceV2({@JsonKey(fromJson: JsonHelper.amountFromJson) required double amount, required String currencyCode}) = _PriceV2;

  /// The PriceV2 from json
  factory PriceV2.fromJson(Map<String, dynamic> json) => _$PriceV2FromJson(json);

  /// The formatted price
  String get formattedPrice => JsonHelper.chooseRightOrderOnCurrencySymbol(amount, currencyCode, priceFormat: priceFormat);
