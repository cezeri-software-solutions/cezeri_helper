...
_UnitPriceMeasurement _$UnitPriceMeasurementFromJson(Map<String, dynamic> json) => _UnitPriceMeasurement(
...
Map<String, dynamic> _$UnitPriceMeasurementToJson(_UnitPriceMeasurement instance) => <String, dynamic>{
