...
import '../../../models.dart';
import '../selling_plan_allocation/selling_plan_allocation.dart';
...
class ProductVariant with _$ProductVariant {
  ...
  factory ProductVariant.fromGraphJson(Map<String, dynamic> json, {bool forceParse = false}) {
    Map<String, dynamic> nodeJson = json['node'] ?? (forceParse ? json : const {});

    return ProductVariant(
      price: nodeJson.containsKey('priceV2') ? PriceV2.fromJson(nodeJson['priceV2']) : PriceV2.fromJson(nodeJson['price']),
      title: nodeJson['title'],
      image: nodeJson['image'] != null ? ShopifyImage.fromJson(nodeJson['image']) : null,
      compareAtPrice:
          nodeJson['compareAtPrice'] != null || nodeJson['compareAtPriceV2'] != null
      ...
      unitPriceMeasurement: nodeJson['unitPriceMeasurement'] != null ? UnitPriceMeasurement.fromJson(nodeJson['unitPriceMeasurement']) : null,
